...
CUDA_VISIBLE_DEVICES=0 python -m samd_sam_only.inference.cli --model /data/models/vicuna-7b-v1.3
Other commands:
...
from samd_sam_only import SamdConfig, SamdModel, DraftModel, SamdGenerationConfig, load_sam
